...
@Setter
@ToString
@TankMessage(id = GetRoomRankReq.MESSAGE_ID)
public class GetRoomRankReq {
    public static final int MESSAGE_ID = TankConstants.MESSAGE_HEAD + TankConstants.GET_ROOM_RANK_REQ;
}
