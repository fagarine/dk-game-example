 ...
 * @author fagarine
 */
public class PublicChatReq {

    /** 使用常量记录id，可通过{@link cn.laoshini.dk.register.ClassIdReader#fieldReader(String)}创建一个id读取器对象读取类的id */
    public static final int MESSAGE_ID = ChatConstants.GAME_ID * 1000 + ChatConstants.PUBLIC_CHAT_REQ_ID;
    ...
    public String toString() {
        return "PublicChatReq{" + "content='" + content + '\'' + '}';
    }
}
